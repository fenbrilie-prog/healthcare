/* ============================================================
   ChiliPiper marketing router — HubSpot form submit handler
   ============================================================ */
/* ChiliPiper handler: listens globally for HubSpot form-submit events
   and routes to the inbound-router calendar booking flow.
   This snippet matches the spec provided and runs at page load. */
(function() {
...
/* ============================================================
   UI behaviour — tab switcher, modal, smooth scroll
   ============================================================ */
(function() {
  /* ===== Tab switcher ===== */
  ...
  function mountHubspotForm() {
    ...
    if (!(window.hbspt && window.hbspt.forms && typeof window.hbspt.forms.create === 'function')) {
      /* HubSpot script not yet loaded — try again shortly */
    ...
    hbspt.forms.create({
      ...
      onFormSubmit: function($form) {
        ...
        } catch (err) { /* swallow — don't block submit */ }
      }
    });
  ...
  /* ===== Smooth scroll for in-page anchors within the namespace =====
     Skips anchors that open the modal so we don't double-handle. */
